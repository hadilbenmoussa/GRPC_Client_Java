...
public final class GreeterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<greet.Greet.HelloRequest,
      greet.Greet.HelloReply> getParrotSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ParrotSayHello",
      requestType = greet.Greet.HelloRequest.class,
      responseType = greet.Greet.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<greet.Greet.HelloRequest,
      greet.Greet.HelloReply> getParrotSayHelloMethod() {
    io.grpc.MethodDescriptor<greet.Greet.HelloRequest, greet.Greet.HelloReply> getParrotSayHelloMethod;
    if ((getParrotSayHelloMethod = GreeterGrpc.getParrotSayHelloMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getParrotSayHelloMethod = GreeterGrpc.getParrotSayHelloMethod) == null) {
          GreeterGrpc.getParrotSayHelloMethod = getParrotSayHelloMethod = 
              io.grpc.MethodDescriptor.<greet.Greet.HelloRequest, greet.Greet.HelloReply>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  greet.Greet.HelloReply.getDefaultInstance()))
                  .setSchemaDescriptor(new GreeterMethodDescriptorSupplier("ParrotSayHello"))
                  .build();
          }
        }
     }
     return getParrotSayHelloMethod;
  }
  ...
  public static abstract class GreeterImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void parrotSayHello(greet.Greet.HelloRequest request,
        io.grpc.stub.StreamObserver<greet.Greet.HelloReply> responseObserver) {
      asyncUnimplementedUnaryCall(getParrotSayHelloMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            getParrotSayHelloMethod(),
            asyncServerStreamingCall(
              new MethodHandlers<
                greet.Greet.HelloRequest,
                greet.Greet.HelloReply>(
                  this, METHODID_PARROT_SAY_HELLO)))
          .build();
    }
  }
  ...
  public static final class GreeterStub extends io.grpc.stub.AbstractStub<GreeterStub> {
    ...
    public void parrotSayHello(greet.Greet.HelloRequest request,
        io.grpc.stub.StreamObserver<greet.Greet.HelloReply> responseObserver) {
      asyncServerStreamingCall(
          getChannel().newCall(getParrotSayHelloMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class GreeterBlockingStub extends io.grpc.stub.AbstractStub<GreeterBlockingStub> {
    ...
    /**
     */
    public java.util.Iterator<greet.Greet.HelloReply> parrotSayHello(
        greet.Greet.HelloRequest request) {
      return blockingServerStreamingCall(
          getChannel(), getParrotSayHelloMethod(), getCallOptions(), request);
    }
  }
  ...
  private static final int METHODID_PARROT_SAY_HELLO = 1;
      ...
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((greet.Greet.HelloRequest) request,
              (io.grpc.stub.StreamObserver<greet.Greet.HelloReply>) responseObserver);
          break;
        case METHODID_PARROT_SAY_HELLO:
          serviceImpl.parrotSayHello((greet.Greet.HelloRequest) request,
              (io.grpc.stub.StreamObserver<greet.Greet.HelloReply>) responseObserver);
          break;
        default:
      ...
      synchronized (GreeterGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getParrotSayHelloMethod())
              .build();
        }
      }
    }
